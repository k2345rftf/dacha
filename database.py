...
class CounterUnit(Base):
    ...
    def __repr__(self):
        return "<{}(user_id = {}, dateUnstCount = {}, typeCounter = {}, classAccur = {}". format(self.user_id,
                                                                                                self.dateUnstCount,
                                                                                                self.typeCounter,
                                                                                                self.classAccur)
...
class Counter(Base):
    ...
    def __init__(self, date, time, id_counter, user_id, name_counter, value):
        self.date = date
